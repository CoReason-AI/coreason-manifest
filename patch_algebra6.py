...
content = content.replace("assert \"completely missing\" in prompt.remediation_prompt", "assert any(\"completely missing\" in r.diagnostic_message for r in prompt.violation_receipts)")
