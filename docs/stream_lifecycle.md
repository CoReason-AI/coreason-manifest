...
> **Note:** The actual wire format for these chunks is defined in the [SSE Wire Protocol Specification](transport/sse-spec.md). The `StreamPacket` wraps these logical events.
