...
from coreason_manifest.definitions.audit import AuditLog, AuditEventType, GenAIOperation
from coreason_manifest.definitions.agent import AgentDefinition, AgentConfig, AgentMetadata, AgentInterface, AgentDependencies
...
def test_audit_log_legacy_key_rejection():
...
def test_audit_log_trace_id_requirement():
...
def test_gen_ai_operation_legacy_key_rejection():
...
def test_agent_definition_legacy_key_rejection():
    ...
    data = {
        ...
        "topology": { # Legacy key
            "nodes": [], "edges": [], "entry_point": "start", "model_config": {"model": "gpt-4", "temperature": 0.1}
        },
        "dependencies": {},
        "integrity_hash": "a"*64
    }
...
def test_recipe_manifest_legacy_key_rejection():
