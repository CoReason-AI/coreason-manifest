...
def test_calculate_latent_alignment_fuzz(v1_floats: list[float], v2_floats: list[float]) -> None:
    ...
    v1 = VectorEmbeddingState(vector_base64=base64.b64encode(v1_packed).decode(), dimensionality=dim, tensor_manifold="fuzz")
    v2 = VectorEmbeddingState(vector_base64=base64.b64encode(v2_packed).decode(), dimensionality=dim, tensor_manifold="fuzz")
    ...
    with unittest.mock.patch("numpy.dot") as mock_dot:
        ...
        with unittest.mock.patch("numpy.linalg.norm", return_value=1.0):
            ...
            v1 = VectorEmbeddingState(
                vector_base64=base64.b64encode(v1_packed).decode(), dimensionality=dim, tensor_manifold="fuzz"
            )
            v2 = VectorEmbeddingState(
                vector_base64=base64.b64encode(v2_packed).decode(), dimensionality=dim, tensor_manifold="fuzz"
            )
