...
def test_apply_state_differential_extra() -> None:
    ...
    manifest1 = StateDifferentialManifest(
        diff_id="did:web:patch-1", author_node_id="did:web:node-1", lamport_timestamp=1, vector_clock={"did:web:node-1": 1},
    ...
    manifest2 = StateDifferentialManifest(
        diff_id="did:web:patch-2", author_node_id="did:web:node-1", lamport_timestamp=1, vector_clock={"did:web:node-1": 1},
    ...
    manifest3 = StateDifferentialManifest(
        diff_id="did:web:patch-3", author_node_id="did:web:node-1", lamport_timestamp=1, vector_clock={"did:web:node-1": 1},
    ...
    manifest4 = StateDifferentialManifest(
        diff_id="did:web:patch-4", author_node_id="did:web:node-1", lamport_timestamp=1, vector_clock={"did:web:node-1": 1},
    ...
    manifest5 = StateDifferentialManifest(
        diff_id="did:web:patch-5", author_node_id="did:web:node-1", lamport_timestamp=1, vector_clock={"did:web:node-1": 1},
    ...
    manifest6 = StateDifferentialManifest(
        diff_id="did:web:patch-6", author_node_id="did:web:node-1", lamport_timestamp=1, vector_clock={"did:web:node-1": 1},
    ...
    manifest7 = StateDifferentialManifest(
        diff_id="did:web:patch-7", author_node_id="did:web:node-1", lamport_timestamp=1, vector_clock={"did:web:node-1": 1},
    ...
    manifest8 = StateDifferentialManifest(
        diff_id="did:web:patch-8", author_node_id="did:web:node-1", lamport_timestamp=1, vector_clock={"did:web:node-1": 1},
...
def test_verify_merkle_proof() -> None:
    node1 = ExecutionNodeReceipt(
        request_id="req1", inputs="in", outputs="out", root_request_id="req1"
    )
    node2 = ExecutionNodeReceipt(
        request_id="req2", parent_request_id="req1", root_request_id="req1", inputs="in2", outputs="out2",
        parent_hashes=[node1.node_hash] # type: ignore
    )
    node3 = ExecutionNodeReceipt(
        request_id="req3", parent_request_id="req1", root_request_id="req1", inputs="in3", outputs="out3",
        parent_hashes=["bad_hash"]
    )
    node4 = ExecutionNodeReceipt(
        request_id="req4", parent_request_id="req1", root_request_id="req1", inputs="in4", outputs="out4",
        parent_hashes=[node1.node_hash] # type: ignore
    )
