...
def test_semantic_relational_vector_occurrent_temporality(valid_from: float) -> None:
    ...
    vector_state = SemanticRelationalVectorState(
    ...
    assert vector_state.ontology_class == UpperOntologyClassProfile.OCCURRENT
...
def test_semantic_relational_vector_continuant_no_temporality(timestamp: float) -> None:
    ...
    assert vector_state.ontology_class == UpperOntologyClassProfile.CONTINUANT
