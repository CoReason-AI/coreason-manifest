...
def test_superposition_variance_zero() -> None:
    with pytest.raises(ValidationError, match=r"variance threshold is 0.0"):
        UtilityJustificationGraphReceipt.model_validate(
            {
                "optimizing_vectors": {"a": 1.0},
                "degrading_vectors": {"b": 1.0},
                "ensemble_spec": {"concurrent_branch_cids": ["branch_12345"], "fusion_function": "weighted_consensus"},
