...
def test_calculate_latent_alignment(vec1_list: list[float], vec2_list: list[float], min_similarity: float) -> None:
    ...
    v1 = VectorEmbeddingState(vector_base64=b1, dimensionality=dim, tensor_manifold="model1")
    v2 = VectorEmbeddingState(vector_base64=b2, dimensionality=dim, tensor_manifold="model1")
