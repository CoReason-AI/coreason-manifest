...
@given(
    a=st.sampled_from(list(EpistemicClassificationProfile)),
    b=st.sampled_from(list(EpistemicClassificationProfile)),
)
def test_information_classification_profile_comparisons(
    a: EpistemicClassificationProfile, b: EpistemicClassificationProfile
) -> None:
