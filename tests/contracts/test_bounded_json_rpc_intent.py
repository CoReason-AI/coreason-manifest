...
def test_json_rpc_intent_max_dict_key_length() -> None:
    ...
    with pytest.raises(ValidationError, match=r"Volumetric Boundary Breach: Dictionary key string geometry exceeds absolute maximum topological length of 10000\."):
        BoundedJSONRPCIntent(jsonrpc="2.0", method="test_method", params=params, id=1)
