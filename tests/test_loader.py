...
def test_load_from_dict_valid(valid_agent_data):
...
def test_load_from_dict_invalid_missing_field(valid_agent_data):
...
def test_load_from_dict_invalid_version(valid_agent_data):
...
def test_load_from_file_valid(tmp_path, valid_agent_data):
...
def test_load_from_file_invalid_yaml(tmp_path):
...
def test_load_from_file_not_a_dict(tmp_path):
...
def test_load_from_file_os_error(tmp_path):
