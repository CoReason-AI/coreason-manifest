...
def test_federated_state_patch() -> None:
    ...
    patch = FederatedStatePatch(
        patch_id=UUID("123e4567-e89b-42d3-a456-426614174000"),
        originating_institution_id="inst_a",
        target_workflow_id=UUID("123e4567-e89b-42d3-a456-426614174001"),
        vector_clock=vc,
        operations=(op,),
        cryptographic_signature="sha256:abc123def456",
    )
    assert str(patch.patch_id) == "123e4567-e89b-42d3-a456-426614174000"
...
def test_federated_suspense_envelope() -> None:
    envelope = FederatedSuspenseEnvelope(
        envelope_id=UUID("123e4567-e89b-42d3-a456-426614174002"),
        required_signatures=("inst_a", "inst_b"),
        current_signatures=("inst_a",),
    )
    assert str(envelope.envelope_id) == "123e4567-e89b-42d3-a456-426614174002"
