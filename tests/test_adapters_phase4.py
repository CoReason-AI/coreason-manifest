from coreason_manifest.spec.core.flow import LinearFlow, GraphFlow, Graph, FlowMetadata, FlowInterface, Edge
...
def test_langchain_adapter_invalid_input():
    with pytest.raises(ValueError):
        flow_to_langchain_config("invalid")
