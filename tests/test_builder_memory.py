...
def test_agent_builder_with_memory_full_config():
...
def test_agent_builder_with_memory_minimal_config():
...
def test_agent_builder_with_memory_partial_config():
    ...
    builder3.with_memory(
        skill_library_ref="libs"
    )
