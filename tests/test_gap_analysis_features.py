...
from coreason_manifest.definitions.message import ChatMessage, Role, TextPart, ToolCallResponsePart, ToolCallRequestPart
from coreason_manifest.definitions.audit import GenAITokenUsage, GenAIOperation, ReasoningTrace, CognitiveStep
...
class TestGapAnalysisFeatures(unittest.TestCase):
    ...
    def test_message_factories(self):
        ...
        self.assertIsInstance(user_msg.parts[0], TextPart)
        self.assertEqual(user_msg.parts[0].content, "Hello")
        ...
        self.assertIsInstance(asst_msg.parts[0], TextPart)
        self.assertEqual(asst_msg.parts[0].content, "Hi there")
        ...
        self.assertIsInstance(tool_msg.parts[0], ToolCallResponsePart)
        self.assertEqual(tool_msg.parts[0].id, "call_123")
        self.assertEqual(tool_msg.parts[0].response, {"result": "success"})
    ...
    def test_genai_operation_factory(self):
        ...
        self.assertEqual(msg.parts[0].content, "Thinking process...")
        ...
        self.assertEqual(step2.output_messages[0].parts[0].content, "More thinking")
        ...
        self.assertEqual(step3.output_messages[0].parts[0].content, "Thinking")

    def test_reasoning_trace_metadata(self):
