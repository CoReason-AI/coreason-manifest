import pytest
from coreason_manifest.spec.core.flow import GraphFlow, LinearFlow, Graph, FlowMetadata, FlowInterface
from coreason_manifest.spec.core.nodes import PlaceholderNode
from coreason_manifest.spec.interop.exceptions import ManifestError, FaultSeverity, RecoveryAction

def test_graph_flow_lifecycle_validation():
    """
    ...
    graph = Graph(
        nodes={"placeholder_1": placeholder},
        edges=[]
    )
...
def test_linear_flow_lifecycle_validation():
    """
