...
from coreason_manifest.v2.spec.definitions import ManifestV2, AgentStep, CouncilStep, SwitchStep, LogicStep
...
def test_council_step_referencing_tool() -> None:
    ...
    with pytest.raises(ValidationError, match="CouncilStep 'step-1' references voter 'my-tool' which is not an AgentDefinition"):
        ManifestV2.model_validate(data)
