...
def _apply_patch_copy_move(new_state: Any, target: Any, last_part: str, patch: Any) -> None:
    ...
    try:
        ...
        raise ValueError(f"Invalid from_path operation: {e}")
...
def apply_state_differential(
    ...
    for patch in manifest.patches:
        ...
        try:
            ...
            if patch.op in ("remove", "replace") and not "Patch test operation failed" in str(e) and not "Index out of bounds" in str(e) and not "Cannot extract from end of array" in str(e):
