...
def _validate_ssrf_safety(url: Any) -> Any:
    ...
    try:
        ...
        try:
            ...
            try:
                # If the hostname can be parsed by socket.inet_aton, it represents a valid numeric IPv4 address
                # Handle representations like 0x7f000001, 2130706433, or 127.1
                import socket
                ...
                # Not a numeric IP format that inet_aton can parse (e.g. standard domains),
