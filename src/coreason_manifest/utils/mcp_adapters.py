...
class DeterministicTransportAdapter:
    ...
    # ⚡ Bolt Optimization: Instantiate msgspec.json.Encoder once at the class level and reuse it
    # across calls to avoid the expensive setup cost on every serialization.
