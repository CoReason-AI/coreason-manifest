...
class EscalationIntent(CoreasonBaseModel):
    ...
    resolution_schema: dict[str, Any] = Field(
        description=(
            "The strict JSON Schema requiring an explicit cryptographic "
...
AnyPresentationIntent = Annotated[
    InformationalIntent | DraftingIntent | AdjudicationIntent | EscalationIntent,
    Field(discriminator="type", description="A discriminated union of human-in-the-loop interaction boundaries."),
]
