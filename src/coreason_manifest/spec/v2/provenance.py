...
class ProvenanceData(CoReasonBaseModel):
    ...
    generated_date: datetime | None = Field(None, description="Timestamp of creation.")
    rationale: str | None = Field(None, description="Reasoning behind the creation.")
    original_intent: str | None = Field(None, description="The original user prompt or goal.")
    confidence_score: float | None = Field(None, ge=0.0, le=1.0, description="System confidence score (0.0 - 1.0).")
    methodology: str | None = Field(None, description="The methodology used to generate this.")
