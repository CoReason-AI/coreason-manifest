...
class CausalDiscoveryIntent(CoreasonBaseState):
    ...
    max_discrete_bins: int = Field(
        default=10, le=100, description="The maximum number of bins for continuous variables."
    )
...
class CommercialOverrideReceipt(CoreasonBaseState):
    ...
    signature_algorithm: Literal["Ed25519", "ML-DSA-44", "ML-DSA-65", "ML-DSA-87", "ES256"] = Field(
        default="ML-DSA-65",
...
class ClinicalVocabularyMappingState(CoreasonBaseState):
    """
    ...
    source_code: Annotated[str, Field(description="Local billing/EHR code", max_length=256)]
    source_vocabulary: Annotated[str, Field(description="The source vocabulary identifier", max_length=256)]
    target_concept_id: Annotated[int, Field(description="OMOP standard concept ID", gt=0)]
    target_concept_name: Annotated[str, Field(description="Preferred standard term", max_length=256)]
    domain_id: Annotated[
        Literal["Condition", "Drug", "Procedure", "Measurement", "Observation", "Device"],
        Field(description="OMOP domain identifier"),
    ]
    mapping_status: Annotated[
        Literal["APPROVED", "PENDING_REVIEW", "UNMAPPED"], Field(description="Status of the concept mapping")
    ]
    confidence_score: Annotated[float, Field(description="Confidence score of mapping", ge=0.0, le=1.0)]
    formal_backing_receipt_cid: Annotated[
        str | None, Field(description="Optional cryptographic CID of formal backing receipt", max_length=256)
    ] = None


class OntologicalVocabularyLookupIntent(CoreasonBaseState):
    """
    ...
    query_term: Annotated[str, Field(description="Query term or source code to search for", max_length=1024)]
...
class OntologicalVocabularyLookupReceipt(CoreasonBaseState):
    ...
    lookup_intent_cid: Annotated[
        str, Field(description="Cryptographic CID of the triggering lookup intent", max_length=256)
    ]
...
OntologicalVocabularyLookupIntent.model_rebuild()
OntologicalVocabularyLookupReceipt.model_rebuild()
...
# CORESIG: 96bf95e3576a2534ea172a4a831d97b770d7090764e190988bddd8623cde71e0143aac5be69ad9157e8a62789428870ab248a7f93ccd8f32e7a3ef07a4eece07
