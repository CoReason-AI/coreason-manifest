...
class ConstitutionalAmendmentProposal(CoreasonBaseModel):
    ...
    justification: str = Field(
        description="The AI's natural language structural/logical argument for why this patch "
...
# =========================================================================
# AGENT INSTRUCTION: This must live at the absolute bottom of ontology.py to
# prevent Pytest from bypassing __init__.py during test discovery.

_namespace = globals().copy()

CompositeNode.model_rebuild(_types_namespace=_namespace)
BaseTopology.model_rebuild(_types_namespace=_namespace)
DAGTopology.model_rebuild(_types_namespace=_namespace)
CouncilTopology.model_rebuild(_types_namespace=_namespace)
SwarmTopology.model_rebuild(_types_namespace=_namespace)
EvolutionaryTopology.model_rebuild(_types_namespace=_namespace)
SMPCTopology.model_rebuild(_types_namespace=_namespace)
EvaluatorOptimizerTopology.model_rebuild(_types_namespace=_namespace)
DigitalTwinTopology.model_rebuild(_types_namespace=_namespace)

WorkingMemorySnapshot.model_rebuild(_types_namespace=_namespace)
