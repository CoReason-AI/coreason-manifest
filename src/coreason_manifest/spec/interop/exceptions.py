...
class LineageIntegrityError(DomainValidationError):
    ...
    def __init__(
        self, message: str, report: ComplianceReport | None = None, remediation: RemediationAction | None = None
    ) -> None:
        super().__init__(message=message, report=report, remediation=remediation, error_code="CRSN-SEC-LINEAGE-001")
...
class SecurityJailViolationError(DomainValidationError):
    ...
    def __init__(
        ...
        super().__init__(message=message, report=report, remediation=remediation, error_code="CRSN-SEC-JAIL-002")
