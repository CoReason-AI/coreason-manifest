...
class ManifestErrorCode(StrEnum):
    ...
    CRSN_VAL_TOPOLOGY_EMPTY = "CRSN-VAL-TOPOLOGY-EMPTY"
    CRSN_VAL_TOPOLOGY_ID_MISMATCH = "CRSN-VAL-TOPOLOGY-ID-MISMATCH"
    CRSN_VAL_TOPOLOGY_MISSING_ENTRY = "CRSN-VAL-TOPOLOGY-MISSING-ENTRY"
    CRSN_VAL_TOPOLOGY_DANGLING_EDGE = "CRSN-VAL-TOPOLOGY-DANGLING-EDGE"
    CRSN_VAL_TOPOLOGY_CYCLE = "CRSN-VAL-TOPOLOGY-CYCLE"
    CRSN_VAL_TOPOLOGY_LINEAR_EMPTY = "CRSN-VAL-TOPOLOGY-LINEAR-EMPTY"
    CRSN_VAL_TOPOLOGY_NODE_ID_COLLISION = "CRSN-VAL-TOPOLOGY-NODE-ID-COLLISION"
    CRSN_VAL_LIFECYCLE_UNRESOLVED = "CRSN-VAL-LIFECYCLE-UNRESOLVED"
    ...
    SECURITY_TOKEN_TAMPERING = "SECURITY_TOKEN_TAMPERING"
